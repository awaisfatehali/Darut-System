  ...
  return (
    <>
      <style>{`
        ...
        .f6 { animation: fadeUp 0.5s ease both 0.55s; }
        .f7 { animation: fadeUp 0.5s ease both 0.65s; }
        .bento {
      ...
      <div className="min-h-screen lg:px-28 bg-black text-white overflow-hidden">
        ...
        <div className="px-4 md:px-6 pt-32 pb-20">
          ...
          <div className="f1 mb-10">
            ...
            <div className="flex items-end justify-between flex-wrap gap-4">
              ...
              <p className="text-white/35 text-sm max-w-sm leading-relaxed">
                Built with passion at the University of Education, Lahore —
                detecting depression through the power of Roman Urdu AI.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-12 gap-4">
            {/* University — 9 cols */}
            <div className="f2 bento col-span-12 md:col-span-9 bg-[#0a0a0a] border border-[#1e1e1e] rounded-2xl p-7 flex items-center gap-6 dot-grid relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-[#0a0a0a] via-[#0a0a0a]/95 to-transparent" />
              <div className="relative z-10 flex items-center gap-6 w-full">
                <div className="w-20 h-20 rounded-2xl border-2 border-dashed border-[#2a2a2a] hover:border-blue-500/40 transition-colors flex flex-col items-center justify-center flex-shrink-0 gap-1 cursor-pointer">
                  <img
                    src={logo}
                    alt="University of Education"
                    className="w-20 h-20 rounded-2xl object-contain p-1"
                  />
                </div>
                <div>
                  ...
                  <p className="text-sm text-white/40">
                    Division of Science & Technology, Lahore · Dept. of CS & IT
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* DARUT tag — 3 cols */}
            <div className="f2 bento col-span-12 md:col-span-3 bg-blue-600/10 border border-blue-500/20 rounded-2xl p-7 flex flex-col justify-between">
            ...
            {/* Member 1 — 3 cols */}
            <div className="f3 bento col-span-12 sm:col-span-6 md:col-span-3 bg-[#0a0a0a] border border-[#1e1e1e] rounded-2xl p-7">
              <div className="w-12 h-12 rounded-xl bg-blue-600/20 border border-blue-500/20 flex items-center justify-center mb-5">
                <span className="text-sm font-black text-blue-400">IR</span>
              </div>
            ...
            {/* Member 2 — 3 cols */}
            <div className="f4 bento col-span-12 sm:col-span-6 md:col-span-3 bg-[#0a0a0a] border border-[#1e1e1e] rounded-2xl p-7">
              <div className="w-12 h-12 rounded-xl bg-blue-600/20 border border-blue-500/20 flex items-center justify-center mb-5">
                <span className="text-sm font-black text-blue-400">MH</span>
              </div>
              <p className="text-[10px] uppercase tracking-widest text-white/25 font-semibold mb-1">
                FYP Member
              </p>
            ...
            {/* Supervisor — 3 cols */}
            <div className="f5 bento col-span-12 sm:col-span-6 md:col-span-3 bg-[#0a0a0a] border border-[#1e1e1e] rounded-2xl p-7">
              <div className="w-12 h-12 rounded-xl bg-purple-600/20 border border-purple-500/20 flex items-center justify-center mb-5">
                <span className="text-sm font-black text-purple-400">AA</span>
              </div>
              <p className="text-[10px] uppercase tracking-widest text-white/25 font-semibold mb-1">
                Project Supervisor
              </p>
              <h3 className="text-lg font-black text-white">Dr. Aftab Akram</h3>
              <div className="mt-4 pt-4 border-t border-[#1e1e1e]">
                <span className="text-[10px] bg-purple-500/10 text-purple-400/70 border border-purple-500/15 px-2 py-1 rounded-full">
                  Supervisor
                </span>
              </div>
            </div>

            {/* Special Thanks — 3 cols */}
            <div className="f6 bento col-span-12 sm:col-span-6 md:col-span-3 bg-[#0a0a0a] border border-[#1e1e1e] rounded-2xl p-7 relative overflow-hidden">
            ...
            {/* Bottom CTA strip */}
            <div className="f7 col-span-12 bg-[#0a0a0a] border border-[#1e1e1e] rounded-2xl p-6 flex items-center justify-between gap-4 flex-wrap">
              <div>
                <p className="text-xs text-white/25 uppercase tracking-widest font-semibold mb-1">
                  Built with
                </p>
                <div className="flex items-center gap-2 flex-wrap">
                  {["React", "Node.js", "MongoDB", "Python", "TailwindCSS"].map(
                    (t) => (
                      <span
                        key={t}
